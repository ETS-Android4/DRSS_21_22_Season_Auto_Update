...
import org.firstinspires.ftc.teamcode.subsystems.trajectories.RedPARKTrajectory;
...
public class RedPARKAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        trajectory = new RedPARKTrajectory(robot.drive, telemetry);
        ...
        matchTimer.reset();
        trajectory.trajectoryControlState = RedPARKTrajectory.TrajectoryControlState.INITIAL_LIFT;
        trajectory.placeControlState = RedPARKTrajectory.PlaceControlState.SET_HEIGHT;
            ...
            switch (trajectory.trajectoryControlState) {
                case INITIAL_LIFT:
                    switch (trajectory.placeControlState) {
                        case SET_HEIGHT:
                            ...
                            trajectory.trajectoryControlState = RedPARKTrajectory.TrajectoryControlState.INITIAL_MOVE;
                            break;
                    }
                    break;
                ...
                case INITIAL_MOVE:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = RedPARKTrajectory.TrajectoryControlState.PARK;
                    }
                    break;

                case PARK:
                    if (!robot.drive.isBusy()) {
                        trajectory.trajectoryControlState = RedPARKTrajectory.TrajectoryControlState.IDLE;
                    }
                    break;
