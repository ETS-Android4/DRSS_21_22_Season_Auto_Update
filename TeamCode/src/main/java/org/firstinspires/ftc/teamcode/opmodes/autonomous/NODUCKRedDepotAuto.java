...
import org.firstinspires.ftc.teamcode.subsystems.trajectories.NODUCKRedDepotTrajectory;
...
@Autonomous(name = "NO DUCK Red Depot", group = "Autonomous")
public class NODUCKRedDepotAuto extends LinearOpMode {

    CompRobot robot;
    NODUCKRedDepotTrajectory trajectory;
    WebcamRed webcam;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        trajectory = new NODUCKRedDepotTrajectory(robot.drive, telemetry);
        ...
        matchTimer.reset();
        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.INITIAL_LIFT;
        trajectory.placeControlState = NODUCKRedDepotTrajectory.PlaceControlState.SET_HEIGHT;
            ...
            switch (trajectory.trajectoryControlState) {
                case INITIAL_LIFT:
                    switch (trajectory.placeControlState) {
                        case SET_HEIGHT:
                            ...
                            trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.RANDOMIZED_PLACE_TRAJECTORY;
                            break;
                    }
                    break;
                ...
                case RANDOMIZED_PLACE_TRAJECTORY:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.placeControlState = NODUCKRedDepotTrajectory.PlaceControlState.WAIT_FOR_HEIGHT;
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.RANDOMIZED_PLACE;
                    }
                    break;
                    ...
                    switch (trajectory.placeControlState) {
                        case WAIT_FOR_HEIGHT:
                            ...
                            * */
                            if (robot.lift.getHeight() > (liftCustomHeight-2)) {
                                trajectory.placeControlState = NODUCKRedDepotTrajectory.PlaceControlState.MOVE_GANTRY;
                            }
                            break;
                        ...
                        case MOVE_GANTRY:
                            ...
                            if (robot.gantry.getPosition() <= (robot.gantry.DRIVER_POSTION_MIN + (robot.gantry.DRIVER_POSITON_RANGE * gantryExtension) - 1)) {
                                generalTimer.reset();
                                trajectory.placeControlState = NODUCKRedDepotTrajectory.PlaceControlState.PLACE;
                            }
                            break;
                        ...
                        case PLACE:
                            ...
                            if (generalTimer.seconds() > 0.75) {
                                generalTimer.reset();
                                trajectory.placeControlState = NODUCKRedDepotTrajectory.PlaceControlState.RESET;
                            }
                            break;
                            ...
                            if (generalTimer.seconds() > 1) {
                                ...
                                * */
                                if (robot.lift.getHeight() <= 2.0) {
                                    ...
                                    trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.DEPOT_ALIGNMENT_TRAJECTORY1;
                                }
                            }
                            break;
                    }
                ...
                case DEPOT_ALIGNMENT_TRAJECTORY1:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.DEPOT_ALIGNMENT_TRAJECTORY2;
                    }
                    break;
                ...
                case DEPOT_ALIGNMENT_TRAJECTORY2:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.DEPOT_ALIGNMENT_TRAJECTORY3;
                    }
                    break;
                ...
                case DEPOT_ALIGNMENT_TRAJECTORY3:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.INITIAL_DEPOT_TRAJECTORY;
                    }
                    break;
                ...
                case INITIAL_DEPOT_TRAJECTORY:
                    if (!robot.drive.isBusy()) {
                        ...
                        generalTimer.reset();
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.INTAKE;
                    }
                    break;
                ...
                case INTAKE:
                    if ((robot.intake.isLoaded()) || (generalTimer.seconds() > 2)){
                        ...
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.CHECK_CYCLE;
                    }
                    break;
                ...
                case CHECK_CYCLE:
                    ...
                    if (timeLeft > cycleTime) {
                        ...
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.CYCLE_DEPOT_EXIT_TRAJECTORY1;
                    }
                    else {
                        ...
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.PARK;
                    }
                ...
                case CYCLE_DEPOT_EXIT_TRAJECTORY1:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.CYCLE_DEPOT_EXIT_TRAJECTORY2;
                    }
                    break;
                ...
                case CYCLE_DEPOT_EXIT_TRAJECTORY2:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.CYCLE_DEPOT_EXIT_TRAJECTORY3;
                    }
                    break;
                ...
                case CYCLE_DEPOT_EXIT_TRAJECTORY3:
                    if (!robot.drive.isBusy()) {
                        trajectory.cycleAlignToPlaceTrajectory = robot.drive.trajectoryBuilder(poseEstimate)
                                .lineToLinearHeading(new Pose2d(-22, -44, Math.toRadians(240)))
                                .build();
                        robot.drive.followTrajectoryAsync(trajectory.cycleAlignToPlaceTrajectory);
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.CYCLE_ALIGN_TO_PLACE_TRAJECTORY;
                    }
                    break;
                ...
                case CYCLE_ALIGN_TO_PLACE_TRAJECTORY:
                    if (!robot.drive.isBusy()) {
                        ...
                        robot.states.gantryState = States.GantryState.EXTENDING;
                        trajectory.placeControlState = NODUCKRedDepotTrajectory.PlaceControlState.WAIT_FOR_HEIGHT;
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.CYCLE_PLACE;
                    }
                    break;
                        ...
                        case RESET:
                            ...
                            if (generalTimer.seconds() > 1) {
                                ...
                                if (robot.lift.getHeight() <= 2.0) {
                                    ...
                                    trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.CYCLE_ALIGN_TO_DEPOT_TRAJECTORY;
                                }
                            }
                            break;
                    }
                ...
                case PARK:
                    if (!robot.drive.isBusy()) {
                        trajectory.trajectoryControlState = NODUCKRedDepotTrajectory.TrajectoryControlState.IDLE;
                    }
                    break;
