...
import org.firstinspires.ftc.teamcode.subsystems.trajectories.CAROUSELNPRedTrajectory;
...
@Autonomous(name = "CAROUSEL Red Depot NO PLACE", group = "Autonomous")
public class CAROUSELRedAutoNOPLACE extends LinearOpMode {

    CompRobot robot;
    CAROUSELNPRedTrajectory trajectory;
    WebcamRed webcam;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        trajectory = new CAROUSELNPRedTrajectory(robot.drive, telemetry);
        ...
        matchTimer.reset();
        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.INITIAL_LIFT;
        trajectory.placeControlState = CAROUSELNPRedTrajectory.PlaceControlState.SET_HEIGHT;
            ...
            */
            ...
            switch (trajectory.trajectoryControlState) {
                case INITIAL_LIFT:
                    ...
                    trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.INITIAL_MOVE;
                    break;

                case INITIAL_MOVE:
                    if (!robot.drive.isBusy()) {
                        robot.drive.followTrajectoryAsync(trajectory.carouselAlignmentTrajectory);
                        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.CAROUSEL_ALIGNMENT;
                    }
                    break;
                ...
                case CAROUSEL_ALIGNMENT:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.PUSH_INTO_CAROUSEL;
                    }
                    break;
                ...
                case PUSH_INTO_CAROUSEL:
                    if (!robot.drive.isBusy()) {
                        generalTimer.reset();
                        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.SPIN_DUCK;
                    }
                    break;
                ...
                case SPIN_DUCK:
                    ...
                    if (generalTimer.seconds() >= 2.5) {
                        ...
                        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.DEPOT_ALIGNMENT_TRAJECTORY1;
                    }
                ...
                case DEPOT_ALIGNMENT_TRAJECTORY1:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.DEPOT_ALIGNMENT_TRAJECTORY2;
                    }
                    break;
                ...
                case DEPOT_ALIGNMENT_TRAJECTORY2:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.DEPOT_ALIGNMENT_TRAJECTORY3;
                    }
                    break;
                ...
                case DEPOT_ALIGNMENT_TRAJECTORY3:
                    if (!robot.drive.isBusy()) {
                        ...
                        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.INITIAL_DEPOT_TRAJECTORY;
                    }
                    break;

                case INITIAL_DEPOT_TRAJECTORY:
                    if (!robot.drive.isBusy()) {
                        trajectory.trajectoryControlState = CAROUSELNPRedTrajectory.TrajectoryControlState.IDLE;
                    }
                    break;
