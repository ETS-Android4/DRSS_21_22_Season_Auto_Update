 ...
 */
public class CAROUSELBlueTrajectory{
    ...
    public CAROUSELBlueTrajectory(CompMecanumDrive drive, Telemetry telemetry) {
        this.drive = drive;
        ...
        randomizedPlaceTrajectory = drive.trajectoryBuilder(carouselAlignmentTrajectory.end())
                .lineToLinearHeading(new Pose2d(-22, 42, Math.toRadians(120)))
                .build();
